...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        // その理由をコメントへ記述してください。
        // レンダークラスで定義されている Calendar.MONTH は、JANUARY(実値=0)〜UNDECIMBER(実値=11) まで定義が存在し、実際の月の値は、「-1」の値を保持しているため、
        //上記では「+1」することで実際に表示される月の値を調整している。getメソッドで対応すると「月の値+1」となるため、「13月、14月」と表示される。
